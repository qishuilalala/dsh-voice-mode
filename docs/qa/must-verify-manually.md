...
> **定位**：AI 已自动验证 254 项 npm test + tsc 0 错 + verify:dual 4 版（锚点/typecheck/host 3 端点/client mic/console）+ 不变量 I1-I10 + `/voice-mode/config` 4 字段全 non-null。仅剩「AI 无法验证」项需人工。
