...
2. 配置 → [plugin/dsh-voice-mode/README.md §设置](../plugin/dsh-voice-mode/README.md#%E8%AE%BE%E7%BD%AE)（设置表）
3. 使用 → [plugin/dsh-voice-mode/README.md §使用](../plugin/dsh-voice-mode/README.md)
