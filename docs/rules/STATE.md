...
| 4 ADR-0007 步1 | 放行待 docfix | — | **开工前条件**：执行 agent 先补 docfix commit（修 index.ts:292 + index.ts:185 + caption-a11y.test.mjs:46 三处；plan 侧已修完），然后跑 tsc×2/build/npm test 全绿后再开始批 4 改动。 |
