...
#   1) 锚点存在性检查（check-anchors.mjs，四版 + 可按需加中间线）
#   2) 四版本 typecheck（typecheck-dual.sh，各跑 host/client tsc）
...
echo "======== 1/4 锚点检查（0.1.1-rc.2 / 0.1.2-rc.1 / 0.1.5-rc.1 / 0.1.5-rc.2）========"
node scripts/check-anchors.mjs 0.1.1-rc.2 0.1.2-rc.1 0.1.5-rc.1 0.1.5-rc.2

echo "======== 2/4 四版本 typecheck ========"
bash scripts/typecheck-dual.sh 0.1.1-rc.2 0.1.2-rc.1 0.1.5-rc.1 0.1.5-rc.2
...
echo ""
echo "✓✓✓ 全量验证通过：4 版锚点 + 4 版 typecheck + 2 核心 runtime 冒烟（host + client mic/console）"
